 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Catchword" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
    ...
    extends Entity
{
    ...
    @XmlElementRef(name = "Catchword", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> catchword;
    @XmlElementRef(name = "Category", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "DocumentId", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> documentId;
    @XmlElementRef(name = "GenericDescription", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> genericDescription;
    @XmlElementRef(name = "ModelUrl", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> modelUrl;
    @XmlElementRef(name = "Remark", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "MessageText", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageText;
    @XmlElementRef(name = "MessageTypeCode", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageTypeCode;

    /**
     * Gets the value of the catchword property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getCatchword() {
        return catchword;
    }

    /**
     * Sets the value of the catchword property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setCatchword(JAXBElement<String> value) {
        this.catchword = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getMessageTypeCode() {
     ...
     *     
     */
    public void setMessageTypeCode(JAXBElement<String> value) {
