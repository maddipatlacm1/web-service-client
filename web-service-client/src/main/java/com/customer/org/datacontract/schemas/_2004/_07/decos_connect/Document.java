 ...
 *         &lt;element name="ForPublication" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
    ...
    extends Entity
{
    ...
    @XmlElementRef(name = "Barcode", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "DocumentType", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> documentType;
    @XmlElementRef(name = "ExternalReference", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> externalReference;
    @XmlElementRef(name = "ForPublication", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> forPublication;
    @XmlElementRef(name = "InternalReference", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> internalReference;
    @XmlElementRef(name = "Language", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Source", namespace = "http://schemas.datacontract.org/2004/07/Decos.Connect.Entities", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the forPublication property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getForPublication() {
        return forPublication;
    }

    /**
     * Sets the value of the forPublication property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setForPublication(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getInternalReference() {
     ...
     *     
     */
    public void setInternalReference(JAXBElement<String> value) {
