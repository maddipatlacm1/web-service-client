 ...
 *         &lt;element name="sRelEntity" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="oFilter" type="{http://schemas.datacontract.org/2004/07/Decos.Connect.Filters}Filter" minOccurs="0"/&gt;
...
@XmlRootElement(name = "GetLinkedEntitiesWithRelationTypeFilter")
public class GetLinkedEntitiesWithRelationTypeFilter {
    ...
    @XmlElementRef(name = "sRelEntity", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sRelEntity;
    ...
    @XmlElementRef(name = "oFilter", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<Filter> oFilter;
    ...
    /**
     * Gets the value of the sRelEntity property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getSRelEntity() {
        return sRelEntity;
    }

    /**
     * Sets the value of the sRelEntity property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSRelEntity(JAXBElement<String> value) {
        this.sRelEntity = value;
    }
    ...
    /**
     * Gets the value of the oFilter property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Filter> getOFilter() {
        return oFilter;
    }

    /**
     * Sets the value of the oFilter property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Filter }{@code >}
     *     
     */
    public void setOFilter(JAXBElement<Filter> value) {
        this.oFilter = value;
    }
