 ...
 *         &lt;element name="oParentEntity" type="{http://schemas.datacontract.org/2004/07/Decos.Connect.Entities}Entity" minOccurs="0"/&gt;
...
public class GetTask {
    ...
    @XmlElementRef(name = "oParentEntity", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<Entity> oParentEntity;
    ...
    /**
     * Gets the value of the oParentEntity property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Entity> getOParentEntity() {
        return oParentEntity;
    }

    /**
     * Sets the value of the oParentEntity property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Entity }{@code >}
     *     
     */
    public void setOParentEntity(JAXBElement<Entity> value) {
        this.oParentEntity = value;
    }
