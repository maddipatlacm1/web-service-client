 ...
 *       &lt;sequence&gt;
 *         &lt;element name="oFile" type="{http://schemas.datacontract.org/2004/07/Decos.Connect.Entities}File" minOccurs="0"/&gt;
...
public class GetThumbnail {
    ...
    @XmlElementRef(name = "oFile", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<File> oFile;
    ...
    /**
     * Gets the value of the oFile property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<File> getOFile() {
        return oFile;
    }

    /**
     * Sets the value of the oFile property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link File }{@code >}
     *     
     */
    public void setOFile(JAXBElement<File> value) {
        this.oFile = value;
    }
