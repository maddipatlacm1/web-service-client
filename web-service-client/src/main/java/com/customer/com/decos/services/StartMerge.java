 ...
 *         &lt;element name="sTemplateKey" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "StartMerge")
public class StartMerge {
    ...
    @XmlElementRef(name = "sTemplateKey", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sTemplateKey;
    ...
    /**
     * Gets the value of the sTemplateKey property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getSTemplateKey() {
        return sTemplateKey;
    }

    /**
     * Sets the value of the sTemplateKey property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSTemplateKey(JAXBElement<String> value) {
        this.sTemplateKey = value;
    }
