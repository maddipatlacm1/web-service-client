...
@XmlRootElement(name = "GetCollectionIdentifiers")
public class GetCollectionIdentifiers {

    @XmlElementRef(name = "sEntityType", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sEntityType;
     ...
     *     
     */
    public JAXBElement<String> getSEntityType() {
        return sEntityType;
    }
     ...
     *     
     */
    public void setSEntityType(JAXBElement<String> value) {
