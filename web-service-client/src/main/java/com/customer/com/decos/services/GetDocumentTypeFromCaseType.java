 ...
 *         &lt;element name="sDocumentType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "GetDocumentTypeFromCaseType")
public class GetDocumentTypeFromCaseType {
    ...
    @XmlElementRef(name = "sDocumentType", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sDocumentType;
    ...
    /**
     * Gets the value of the sDocumentType property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getSDocumentType() {
        return sDocumentType;
    }

    /**
     * Sets the value of the sDocumentType property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSDocumentType(JAXBElement<String> value) {
        this.sDocumentType = value;
    }
