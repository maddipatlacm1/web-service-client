 ...
 *         &lt;element name="sAuditMessage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
public class LogAudit {
    ...
    @XmlElementRef(name = "sAuditMessage", namespace = "www.decos.com/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sAuditMessage;
    ...
    /**
     * Gets the value of the sAuditMessage property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getSAuditMessage() {
        return sAuditMessage;
    }

    /**
     * Sets the value of the sAuditMessage property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSAuditMessage(JAXBElement<String> value) {
        this.sAuditMessage = value;
    }
